...
class CreateAugmentedDataConfig:
    ...
    player_slot_spacing_factor_range: tuple[float, float] = (0.25, 1.5)
    player_hand_center_jitter_fraction_range: tuple[float, float] = (0.006, 0.03)
    ...
    player_rotation_jitter_deg_range: tuple[float, float] = (4.0, 25.0)
